...
import { 
    ...
    startAt, endAt, limitToLast, increment 
...
export { 
    app, db, storage, auth, 
    ref, set, get, onValue, push, update, remove, query, orderByChild, equalTo, serverTimestamp, onDisconnect, startAt, endAt, limitToLast, increment,
