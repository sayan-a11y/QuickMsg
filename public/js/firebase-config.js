...
import { getDatabase, ref, set, get, onValue, push, update, remove, query, orderByChild, equalTo, serverTimestamp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-database.js";
...
export { app, db, storage, auth, ref, set, get, onValue, push, update, remove, query, orderByChild, equalTo, serverTimestamp, sRef, uploadBytes, getDownloadURL };
